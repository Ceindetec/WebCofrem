                ...
                @can('editar.reglas.esta')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="input-group m-t-10">
                                ...
                                <input type="text" id="valor_min" name="valor_min" class="form-control dinero"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <div class="input-group m-t-10">
                                <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                                <input type="text" id="valor_max" name="valor_max" data-parsley-valorminimo=""
                                       maxlength="20" class="form-control dinero" placeholder="" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Plazo de pago</label>
                        <div class="col-md-10">
                            <input type="number" name="dias" class="form-control" required maxlength="2"
