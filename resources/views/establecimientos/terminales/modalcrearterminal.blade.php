<div id="modalcrearterminal">
    {{Form::open(['route'=>['terminal.crearp',$sucursal_id], 'class'=>'form-horizontal', 'id'=>'crearterminal'])}}
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    {{Form::password('password_confirmation', ['class'=>'form-control', "required", "maxlength"=>"4", "data-parsley-equalto"=>"#password"])}}
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(function () {
        $("#crearterminal").parsley();
        $("#crearterminal").submit(function (e) {
            e.preventDefault();
            var form = $(this);
            $.ajax({
