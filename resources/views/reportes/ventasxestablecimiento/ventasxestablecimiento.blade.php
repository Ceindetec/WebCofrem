...
@section('contenido')
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="header-title m-t-0 m-b-20">Reporte de ventas por establecimiento </h4>
            </div>
        </div> <!-- end row -->
        <div class="row">
            <div class="col-sm-12">
...
@section('scripts')
    ...
    <script>
        ...
        function generarRespuesta() {
            ...
            cargando();
            $('#resultado').load('{{route('resultadoventasxestablecimiento')}}',{rango:rango,establecimientos:establecimientos}, function () {
                fincarga();
            });
        }
